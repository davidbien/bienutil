...
public:
  ...
  CMFDtor0_void() _BIEN_NOTHROW
    : m_pFunc( 0 )
  {
  }
  CMFDtor0_void( _TyObjectPtr _po,
                _TyFunc _pFunc ) _BIEN_NOTHROW
    : m_po( _po ),
      m_pFunc( _pFunc )
  {
  }
...
public:
  ...
  CMFDtor1_void() _BIEN_NOTHROW
    : m_pFunc( 0 )
  {
  }
  CMFDtor1_void( _TyObjectPtr _po,
                _TyFunc _pFunc,
                t_TyP1Call _p1 ) _BIEN_NOTHROW
    : m_po( _po ),
      m_pFunc( _pFunc ),
      m_p1( _p1 )
  {
...
public:
  ...
  // Parameter access.
  t_TyP1Store const & P1() const _BIEN_NOTHROW
  {
    return m_p1;
  }
